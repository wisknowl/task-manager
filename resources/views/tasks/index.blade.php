<x-app-layout>
    <x-slot name="header">
        ...
        <div class="relative flex justify-center gap-2">
            ...
            <!-- Dropdown Form -->
            <div id="taskFormDropdown" class="hidden absolute top-12 w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                <form method="POST" action="" class="space-y-4">
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors duration-200 dark:bg-blue-600 dark:hover:bg-blue-700">
                        Create Task
                    </button>
                </form>
            </div>
    ...
    <script>
        document.getElementById('createTaskButton').addEventListener('click', function() {
            const dropdown = document.getElementById('taskFormDropdown');
